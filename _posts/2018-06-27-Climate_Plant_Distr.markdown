...
![Figure 1 – This figure describes the carbon cycle, and the arrows indicate the flow of carbon. The red arrows identify the Carbon Cycle. Arrows indicate the flow of carbon, with red arrows referring to anthropogenic emissions. Numbers in parenthesis indicate carbon pools (or sinks). Take a closer look at the number and check how much carbon is stored in the soil. Diagram adapted from U.S. DOE, Biological and Environmental Research Information System.From  [NASA Earth Observatory](http://earthobservatory.nasa.gov/Features/CarbonCycle/)]({{site.baseurl}}{{page.figures}}Carbon_cycle.jpg)
*Figure 1 – This figure describes the carbon cycle, and the arrows indicate the flow of carbon. The red arrows identify the Carbon Cycle. Arrows indicate the flow of carbon, with red arrows referring to anthropogenic emissions. Numbers in parenthesis indicate carbon pools (or sinks). Take a closer look at the number and check how much carbon is stored in the soil. Diagram adapted from U.S. DOE, Biological and Environmental Research Information System.From  [NASA Earth Observatory](http://earthobservatory.nasa.gov/Features/CarbonCycle/)*

...
level2: Scientific Process
level3: Scientific Process
level1: Models of SOM dynamics
tags:
- SOM Model
- Climate change
- Century Model
...
![Figure 1 – As an example, see the approach that the modified DNDC SOM Model uses to simulate soil biogeochemistry and GHG dynamics. From [DNDC (Version 9.5) Scientific Basis and Processes](http://www.dndc.sr.unh.edu/papers/DNDC_Scientific_Basis_and_Processes.pdf)](Figure1_Som_Models.png)
...
![Figure 2 – The development of new SOM models occurred at an exponential rate in recent decades, but just a few have been cited multiple times. From [Campbell and Paustian (2015)](https://doi.org/10.1088/1748-9326/10/12/123004)](Figure2_Som_Models.png)
...
![Figure 4 - One of the main challenges faced by SOM models is to estimate across spatial and temporal scales.  From [Campbell and Paustian (2015)](https://doi.org/10.1088/1748-9326/10/12/123004)](Figure4_Som_Models.png)

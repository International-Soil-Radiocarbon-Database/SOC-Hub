...
It's hard to pinpoint individual controls of SOM storage because there are many potential processes occurring across multiple scales.  From the the nano-scale interactions between minerals and SOM to the macro-scale occlusion of large SOM particles by aggregates, the soil system is a complex and hard to study place. 

Historically, SOM was believed to condense into larger more recalcitrant molecules that persisted in soils, a theory known as "humification", and a lot of work in soils in centered around this idea.  However, we have come to understand that humification as a theory doesn't make sense.  Movement away from humification theory was lead by improvements in measurement and visualization of the soil system by techniques like nuclear magnetic resonance (NMR) and in-situ soil chemistry that showed that complex humic macromolecules are not prevalent in the soils.  Instead most carbon resembles plant or microbial biomolecules.   
...
Though it has long been understood by soil scientists that discreet stabilization mechanisms are at work in soils, there has been a lack of dissemination of these ideas to adjoining disciplines that also deal with soils.  Everyone who works with soils should think about physical disconnection, sorption/desorption, and freeze thaw cycles as key mechanisms controlling SOM.  It is also important to understand that carbon inputs into soils are largely controlled by the rhizosphere. 
...
In contemporary times we've come to think of SOM storage as a process of stabilization and de-stabilization by multiple discreet mechanisms in the soil, an idea that was first conceptualized well by Sollins and co-authors circa 1996.  

![Fig 1. Sollins et al. (1996) is a fantastic paper that brings together many of the budding ideas in soil science at the time.  It is a concrete and well discussed paper on how SOM storage can be conceptualized](Sollins stab mech.png)

As paradigms have shifted, its important to get away from humification terminology and embrace mechanistic theories and conceptualizations of soil carbon stabilization.  Below is a visualization of multiple conceptualizations of SOM sequestration and a final consolidated view by Lehmann & Kleber (2015).
...
Importantly, Lehmann & Kleber (2015) illustrate aggregation and mineral sorption as key processes in SOM storage.  They also point out that biopolymer size determines assimilation by microbes.  Though not difinitive, the SCM model is an important step towards an accurate conceptualization of SOM storage.
...
Some amazing new work by Vidal et al. (2018) has highlighted important interactions in the rhizosphere between plant roots, fungi, and bacteria.  The hope is that research like this will inform how we think about SOM and eventually lead to new conceptualizations of SOM storage that can be tested and further refined.  
\newline

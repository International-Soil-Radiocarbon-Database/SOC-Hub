...
![Figure 2. Spectral signature of vanillin (CCl~4~) from [Michigan State University](https://www2.chemistry.msu.edu/faculty/reusch/virttxtjml/spectrpy/infrared/infrared.htm)](IRspec.jpg)  

![Figure 3. A breakdown of the infrared region of the electromagnetic spectrum from [Digital Earth Watch](http://dew.globalsystemsscience.org/key-messages/near-infrared-and-the-electromagnetic-spectrum)](IRbreakdown.jpg)   
...
![Table 1. A list of key soil constituents, their VNIR absorptions, and the associated soil taxonomy diagnostics from Brown et al.(2006) [10.1016/j.geoderma.2005.04.025](http://linkinghub.elsevier.com/retrieve/pii/S0016706105001564)](VNIRtable_Brown(2006).png) 
...
![Figure 4. FTIR spectra of kaolin, bentonite, and calcium carbonate from Du and Zhou (2011) [10.1080/05704928.2011.570837](https://www.tandfonline.com/doi/abs/10.1080/05704928.2011.570837)](FTIRspectra_mainclayminerals.png) 
...
![Figure 5. Spectrum of Camphor from [Michigan State University](https://www2.chemistry.msu.edu/faculty/reusch/virttxtjml/spectrpy/nmr/nmr1.htm)](13CNMR_camphor.jpg)   

![Figure 6. General distribution of carbon chemical shifts associated with different functional groups from [Michigan State University](https://www2.chemistry.msu.edu/faculty/reusch/virttxtjml/spectrpy/nmr/nmr1.htm)](13CNMR_shiftranges.jpg)   
...
![Figure 7. Diagram of Raman spectrometer and the resulting spectra of TAPP Porphyrin powder from [University of Maryland](http://www.chem.umd.edu/wp-content/uploads/2014/01/)](Raman(1).jpg)   

![Figure 8. Compound characteristics as they are related to a spectral signature produced from a Raman spectrometer from [nanophoton](https://www.nanophoton.net/raman/raman-spectroscopy.html)](Raman_1.jpg)   
...
![Figure 9. Example of a XANES/NEXAFS spectra from [Wikipedia](https://en.wikipedia.org/wiki/X-ray_absorption_spectroscopy)](XANES(2).jpg)   
...
![Figure 10. XRF spectra of a sample containing various elements from [Metallurgist](https://www.911metallurgist.com/blog/sample-preparation-methods-for-xrf-analysis)](XRF_1.png)    
